...
### Your application container name will correspond with "project_slug": new_route
...
## even can explicitly point which one by means of:
    ...
    docker compose -f compose_stack.yml up --build new_route

## to make migration you can execute command inside docker app container like this:

    docker container exec new_route_app poetry run alembic upgrade head
...
Go to your GitHub account and create a new repo that matches the **new_route** 
